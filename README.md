...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-radar/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rag-radar.git
cd tp-rag-radar
```
...
```bash
kubectl port-forward deployment/tp-rag-radar 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── drift_detector.py     # Main configuration file
```
...
---
*Generated by [RAG Radar Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-radar/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
